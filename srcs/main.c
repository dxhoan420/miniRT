...
//	add_sphere(&scene, create_vector(10, 0, 20), 20,create_rgb(WHITE));
	...
	add_plane(&scene, create_vector(0, 60, 0), create_vector(0, -1, 0),
		   create_rgb(BLUE));
	add_plane(&scene, create_vector(0, -60, 0), create_vector(0, 1, 0.5f),
		   create_rgb(WHITE));
	add_camera(&cameras, create_vector(0, 0, 0),
					create_vector(0, 0, 1), 60);
	add_light(&scene, create_vector(0, 0, -3),
...
//				   create_rgb_norm(255, 255, 255, 0.2f));
	...
	add_sphere(&scene, create_vector(0, 0, 3), 0.3f,create_rgb(RED));
	add_sphere(&scene, create_vector(-1, 0, 3), 0.3f,create_rgb(RED));
//	add_triangle(&scene, create_vector(-10, 0, 4),
//create_ray(create_vector(10,10, 4),create_vector(10, -10, 4)),
//create_rgb(WHITE));
